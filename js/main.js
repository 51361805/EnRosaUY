...
function cargarProductos() {
 ...
 <a class="carousel-control-next" href="#myCarousel" role="button" data-bs-slide="next">
     ...
     <span class="visually-hidden"></span>
        ...
        <div class="antesAhora">
        <p class="old-price inicio"> $${producto.precioAntes}</p>
...
function mostrarProductos() {
    ...
    productos.forEach(producto => {
        ...
        // Limitar el título a 15 caracteres
        const tituloCorto = producto.titulo.length > 15 ? producto.titulo.substring(0, 15) + "..." : producto.titulo;
        
        div.innerHTML = `
            <img class="product-image" src="${producto.imagen}" alt="Imagen">
            <h2 class="title">${tituloCorto}</h2>
            <div class="antPrecio">
                <p class="old-price">${producto.precioAntes}</p>
